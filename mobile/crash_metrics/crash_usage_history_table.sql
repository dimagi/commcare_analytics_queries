...
(
  ...
  user_segment   STRING   NOT NULL OPTIONS(description = "all, connect, mixed, non_connect or unknown"),
  ...
  total_users    INT64    OPTIONS(description = "Unique active users in the window; NULL for lts and for the unknown segment"),
