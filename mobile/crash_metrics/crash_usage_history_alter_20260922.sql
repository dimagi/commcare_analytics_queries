...
ALTER TABLE `commcare-a57e4.mobile_metrics.crash_usage_history`
  ALTER COLUMN user_segment SET OPTIONS(description = "all, connect or non_connect. A device counts as connect if ccc_enabled was ever set during the window; devices with no GA4 match count as non_connect");
